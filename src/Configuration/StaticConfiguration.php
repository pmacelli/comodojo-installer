...
class StaticConfiguration {
    ...
    private $settings = array(
        ...
        'COMODOJO_DATABASE_MODEL' => 'SQLITE_PDO',
        'COMODOJO_DATABASE_HOST' => 'localhost',
        'COMODOJO_DATABASE_PORT' => 1,
        'COMODOJO_DATABASE_NAME' => COMODOJO_INSTALLER_WORKING_DIRECTORY.'/'.COMODOJO_INSTALLER_LOCAL_DATABASE.'/comodojo.sqlite',
        ...
        'COMODOJO_FRAMEWORK_JS' => COMODOJO_INSTALLER_FRAMEWORK_JS,
        'COMODOJO_FRAMEWORK_TEMPLATES' => COMODOJO_INSTALLER_FRAMEWORK_TEMPLATES,
    );
